...
ARG WALLABAG_VERSION=2.6.10-thinkthinking.6
...
RUN set -ex \
 && curl -L -o /tmp/wallabag.tar.gz https://github.com/thinkthinking/wallabag/releases/download/$WALLABAG_VERSION/wallabag-$WALLABAG_VERSION.tar.gz \
